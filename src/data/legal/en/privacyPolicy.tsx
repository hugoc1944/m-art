...
export const privacyPolicy: LegalPageData = {
  ...
  sections: [

    {
      ...
      content: (
        <>
          ...
          <p>Operating as: M•ART Geneva Makeup Academy</p>
      ...
      content: (
        <>
          <p>
            ...
            or identifiable natural person, directly or indirectly.
          </p>

          <p>
            This includes, for example, names, email addresses, phone numbers,
...

    {
      ...
      content: (
        <>
          ...
          <p><strong>1. When You Contact Us</strong></p>
          ...
          <p><strong>2. When You Browse Our Website</strong></p>

          <p>
            We may automatically collect technical and interaction data such
            as IP address, browser type, device type, pages visited, time
            spent on pages, and interaction events.
          </p>

          <p>
            This data is collected through consent-based tracking tools
            including Google Analytics, Google Tag Manager, Google Ads,
            and Meta Pixel.
          </p>
        </>
      ),
...

    {
      ...
      content: (
        <>
          ...
          <ul className="list-disc ml-[var(--space-6)] space-y-[var(--space-2)]">
            <li>Your consent (for analytics, marketing cookies, and communications)</li>
            <li>Our legitimate interest in responding to inquiries and maintaining website security</li>
            <li>Compliance with applicable legal obligations where required</li>
          </ul>
        </>
      ),
    },

    {
      ...
      content: (
        <>
          <p>Contact form data is retained for a maximum period of 365 days.</p>
      ...
      content: (
        <>
          <p>
            ...
            to protect personal data, including encrypted HTTPS communication,
            secure hosting infrastructure, access control, and database protection.
          </p>
...

    {
      ...
      content: (
        <>
          <p>Our website uses essential, analytics, and marketing cookies.</p>
